      ...
      <section className="min-h-[calc(100vw*16/9)] md:min-h-screen flex flex-col justify-end relative"
        ...
        <div className="hidden md:flex items-center absolute inset-0" style={{ zIndex: 1, padding: '0 24px' }}>
          <div className="max-w-5xl mx-auto w-full">
            ...
            {/* CTA */}
            <div>
              <button onClick={() => { window.location.href = isSignedIn ? '/dashboard' : '/sign-in'; }} style={{
                opacity: heroLoaded ? 1 : 0,
      ...
      <section style={{ ...sectionPad, backgroundColor: '#1A1A2E', textAlign: 'center' }}>
        <div className="max-w-md mx-auto">
          <Reveal>
            ...
            <button onClick={() => { window.location.href = isSignedIn ? '/dashboard' : '/sign-in'; }} style={{ backgroundColor: '#C4A35A', color: '#1A1A2E', fontWeight: 700, fontSize: '16px',
        ...
        <div className={inner}>
          <Reveal>
            ...
            <div className="flex justify-center">
              <button onClick={() => { window.location.href = isSignedIn ? '/dashboard' : '/sign-in'; }} style={{ backgroundColor: 'transparent', color: '#C4A35A', fontWeight: 700, fontSize: '16px',
